...
--
-- insert into transaction (id, session_id, product_id, product_variant_id, product_variant_name, localization, chip, quality, supplier_id, customer_id, confirmed_qty, accepted, brand, category) values (1, 1024, 280, 2122, 'iPhone 11 Dual 128Gb (Purple)', 'RU', null, null, 172, 162, 3, true, 'Apple', 'mobile');
-- insert into transaction (id, session_id, product_id, product_variant_id, product_variant_name, localization, chip, quality, supplier_id, customer_id, confirmed_qty, accepted, brand, category) values (2, 1024, 280, 2122, 'iPhone 11 Dual 128Gb (Purple)', 'RU', null, null, 172, 162, 3, true, 'Apple', 'mobile');
-- insert into transaction (id, session_id, product_id, product_variant_id, product_variant_name, localization, chip, quality, supplier_id, customer_id, confirmed_qty, accepted, brand, category) values (3, 1024, 280, 2122, 'iPhone 11 Dual 128Gb (Purple)', 'RU', null, null, 172, 162, 2, true, 'Apple', 'mobile');
-- insert into transaction (id, session_id, product_id, product_variant_id, product_variant_name, localization, chip, quality, supplier_id, customer_id, confirmed_qty, accepted, brand, category) values (4, 1024, 280, 2122, 'iPhone 11 Dual 128Gb (Purple)', 'RU', null, null, 172, 162, 5, true, 'Apple', 'mobile');
-- insert into transaction (id, session_id, product_id, product_variant_id, product_variant_name, localization, chip, quality, supplier_id, customer_id, confirmed_qty, accepted, brand, category) values (5, 1024, 280, 2122, 'iPhone 11 Dual 128Gb (Purple)', 'RU', null, null, 172, 161, 4, true, 'Apple', 'mobile');
--
